...
const PostJobModal = ({ onClose, onJobPosted }) => {
    ...
    const [location, setLocation] = useState('Remote'); // New state for location
    ...
    const handlePostJob = async (e) => {
        ...
        try {
            ...
            const jobData = {
                ...
                location, // Add location to the data sent to the backend
        ...
        <div className="fixed inset-0 bg-gray-900/80 backdrop-blur-sm flex justify-center items-center z-50 p-4">
            <div className="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-lg transform transition-all">
                ...
                <form onSubmit={handlePostJob} className="space-y-5">
                    ...
                    <p className="text-sm text-center text-gray-500 pt-2">A platform fee of **{PLATFORM_FEE_SOL} SOL** will be charged to post this job.</p>
                    ...
                    <div className="flex justify-end space-x-4 pt-4">
                        ...
                        <button type="submit" disabled={isLoading || !publicKey} className="px-6 py-2 bg-indigo-600 text-white font-semibold rounded-lg disabled:bg-indigo-400 disabled:cursor-not-allowed shadow-md hover:bg-indigo-700 transition-colors">
